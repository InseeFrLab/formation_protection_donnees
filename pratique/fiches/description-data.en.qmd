...
href: pratique/fiches/description-data.en.html
image: ../../images/description-data.png
---


Pour installer les packages nécessaires, vous trouverez les instructions à suivre 
dans la fiche [Ressources / Installer les packages et les outils sur R](../../ressources/fiches/outils-install.en.html). 
