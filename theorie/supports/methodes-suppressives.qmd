...
| 👍 | 👎 |
|:--:|:--:|
| Réduit le SP. | Ne supprime pas totalement le SP. |
| Pas de perte info. | Impossible dans certains cas (structure imposée, suivi dans le temps). |
...
| **Centre** | 11    | 124  | <span style="color:red; font-weight: bold;" title="[141 ; 173]">157 (2)</span>   | 934    | **1226** |
| **Sud**    | 36    | 24  | <span style="color:red; font-weight: bold;" title="[54 ; 66]">60 (1)</span>   | 651   | **771** |
...
| **Centre** | X    | 124  | <span style="color:red; font-weight: bold;" title="[141 ; 173]">X</span>   | 934    | **1226** |
| **Sud**    | X    | 24  | <span style="color:red; font-weight: bold;" title="[54 ; 66]">X</span>   | 651   | **771** |
| **Total**  | **105** | **219** | **309**  | **2385** | **3018** |
...
| **Centre** | [0;105]    | 124  | <span style="color:red; font-weight: bold;" title="[141 ; 173]">[63;168]</span>   | 934    | **1226** |
| **Sud**    | [0;96]    | 24  | <span style="color:red; font-weight: bold;" title="[54 ; 66]">[0;96]</span>   | 651   | **771** |
| **Total**  | **105** | **219** | **309**  | **2385** | **3018** |
...
df <- data.frame(
  ...
  lw = c(20,20,1),
  alph = c(1,1,3),
  typint = c("Intervalle des possibles", "Intervalle de protection", "Valeur de la cellule")
)

ticks <- data.frame(
  x = seq(60,180,10), y = -0.005, ye = 0
)
cellule <- data.frame(x=157, y=-0.02, ye = 0.02, col = "Valeur de la cellule")

ggplot(df) +
  geom_segment(aes(y = y, yend = ye, x = x, xend = xe, colour = typint, linewidth = lw, alpha = alph)) +
  geom_hline(yintercept = 0, linewidth = 0.5) +
  geom_segment(data = ticks, aes(x=x, y=y, yend=ye)) +
  geom_text(data = ticks, aes(x=x, y=y, label = x), vjust = 1.1) +
  geom_text(data = cellule, aes(x = x, y = y, label = x), color = "steelblue", vjust = 1.2) +
  scale_x_continuous("", limits = c(58,182), expand = c(0,0)) +
  scale_y_continuous("", limits = c(-0.1,0.1)) +
  scale_colour_discrete("") + #, type = "qual", palette = 1) +
  scale_alpha_continuous("", range = c(0.3, 0.9)) +
  scale_linewidth_continuous("", range = c(1, 30)) +
...
ggplot(df) +
  ...
  geom_text(data = ticks, aes(x=x, y=y, label = x), vjust = 1.1) +
  geom_text(data = cellule, aes(x = x, y = y, label = x), color = "steelblue", vjust = 1.2) +
  scale_x_continuous("", limits = c(58,285), expand = c(0,0)) +
  scale_y_continuous("", limits = c(-0.1,0.1)) +
  scale_colour_discrete("") + #, type = "qual", palette = 1) +
  scale_alpha_continuous("", range = c(0.3, 0.9)) +
  scale_linewidth_continuous("", range = c(1, 30)) +
...
```{mermaid}
graph TD
  A[**Pays**<br>400] --> B[**Nord**<br>46]
  A --> C[**Ouest**<br>191]
  A --> D[**Est**<br>80]
  A --> E[**Sud**<br>83]
  B --> F[**N1**<br>21]
  B --> G["**N2**<br><font color='red'>2</font>"]
  B --> H[**N3**<br>23]
  C --> I[**O1**<br>32]
  C --> J[**O2**<br>54]
  C --> K[**O3**<br>67]
...
graph TD
  ...
  D --> M[**E1**<br>27]
  D --> N[**E2**<br>41]
  D --> O["**E3**<br><font color='red'>X</font>"]
  E --> P[**S1**<br>44]
  E --> Q[**S2**<br>39]
```
...
graph TD
  ...
  A --> D[**Est**<br>80]
  A --> E[**Sud**<br>83]
  B --> F["**N1**<br><font color='red'>X</font>"]
  B --> G["**N2**<br><font color='red'>2</font>"]
  B --> H[**N3**<br>23]
  C --> I[**O1**<br>32]
  C --> J[**O2**<br>54]
...
- champs différents et non complémentaires => indépendance
- variable de réponses différentes (et non liées par une équation / corrélation) => indépendance
- variables de croisement toutes différentes => indépendance
...
<div style="flex: 1;">
<p><strong>CA fourchettes</strong></p>
...
On crée une nouvelle variable de croisement "type_couverts".
...
Il faut traiter deux tableaux avec deux hiérarchies différentes.

```{mermaid}
graph TD
  subgraph GROUPE_1["GROUPE 1"]
    A[Total] --> B[<25]
    A --> C[25-29]
    D --> F[30-49]
    A --> D[30-69]
  ...
  subgraph GROUPE_2["+50"]
    H[+50] --> G
    H --> E
  end

  %% on donne une classe au subgraph via son nom
  classDef groupe1Style fill:#e0f7fa,stroke:#00796b,stroke-width:2px,color:#004d40;
  class GROUPE_1 groupe1Style;

  classDef groupe2Style fill:#fff3e0,stroke:#ef6c00,stroke-width:2px,color:#bf360c;
  class GROUPE_2 groupe2Style;
```
...
```{mermaid}
graph TD
  subgraph grp1["hiérarchie principale"]
    A[Total] --> B[<25]
    A --> C[25-29]
    A --> D[30-69]
    A --> E[70+]
  ...
  %% on donne une classe au subgraph via son nom
  classDef groupe1Style fill:#e0f7fa,stroke:#00796b,stroke-width:2px,color:#004d40;
  class grp1 groupe1Style;

  classDef groupe2Style fill:#fff3e0,stroke:#ef6c00,stroke-width:2px,color:#bf360c;
  class grp2 groupe2Style;
```