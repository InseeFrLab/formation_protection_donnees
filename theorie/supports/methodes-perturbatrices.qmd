...
::: {#tbl-ckm-avtg-incv style="font-size: 80%;" .table .table-striped .table-hover}
|                       Avantages                        |                                Inconvénients                                 |
| :----------------------------------------------------: | :--------------------------------------------------------------------------: |
...
::: {#tbl-bruit-add-avtg-incv style="font-size: 80%;" .table .table-striped .table-hover}
|                Avantages                |       Inconvénients       |
| :-------------------------------------: | :-----------------------: |
...
::: {#tbl-trs-avtg-incv style="font-size: 80%;" .table .table-striped .table-hover}
|                                          Avantages                                          |                                                Inconvénients                                                |
| :-----------------------------------------------------------------------------------------: | :---------------------------------------------------------------------------------------------------------: |
...
::: {#tbl-pram-avtg-incv style="font-size: 80%;" .table .table-striped .table-hover}
|                                                        Avantages                                                        |                                              Inconvénients                                              |
| :---------------------------------------------------------------------------------------------------------------------: | :-----------------------------------------------------------------------------------------------------: |
